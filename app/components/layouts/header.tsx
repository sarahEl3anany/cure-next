...
function Header() {
  return (
    <nav className="w-full fixed top-0 left-0 flex items-center justify-between px-2 md:px-10 py-5 z-50 bg-white">
      <Link href="/">
        <HeartComponent className="w-10 h-10 object-contain cursor-pointer" />
      </Link>
      <div className="justify-center items-center w-[568px] hidden md:flex">
