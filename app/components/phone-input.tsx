...
>(({ className, ...props }, ref) => (
  <Input
    className={cn("focus:border-primary-300 focus:shadow-[0_0_0_0.2rem_var(--color-primary-100)] focus:outline-0 focus:outline-offset-0 shadow-none rounded-e-md rounded-s-md border-none bg-transparent outline-none ring-0 focus:ring-0 focus:ring-offset-0 focus:outline-none focus:border-none focus-visible:ring-0 focus-visible:outline-none transition-none", className)}
    {...props}
    ref={ref}
  />
));
  ...
  return (
    ...
    <Popover open={isOpen} modal onOpenChange={setIsOpen}>
      <PopoverTrigger asChild>
        <Button
          className="flex gap-1 rounded-e-none rounded-s-md border-none px-3"
          disabled={disabled}
        >
